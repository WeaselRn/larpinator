...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  {
    ...
    name: "Buzzword Farmer",
    icon: "🧢",
    description: "Hit 90+ on Buzzword Farming in a single analysis. The vocabulary is immaculate.",
  ...
  },
  {
    ...
    name: "Cringe Lord",
    icon: "🤡",
    description: "Hit 90+ on The Ick in a single analysis. The ick is off the charts.",
  ...
  },
  {
    ...
    name: "Delulu Maxxer",
    icon: "💀",
    description: "Hit 90+ on Delulu in a single analysis. Reality left the group chat.",
  ...
  },
  {
    ...
    name: "Aura Farmer",
    icon: "⚡",
    description: "Hit 90+ on Aura in a single analysis. Mewing so hard the universe feels it.",
  ...
  },
  {
    ...
    name: "Actually Real??",
    icon: "🧘",
    description: "Held an overall LARP score of 20 or below with at least one completed analysis. Suspiciously grounded.",
  ...
  },
  {
    ...
    name: "LARP Slayer",
    icon: "⚔️",
    description: "Won 3 LARP battles. The delulu doesn't survive you.",
  ...
  },
  {
    ...
    name: "LARP GOD",
    icon: "👑",
    description: "Reached an overall LARP score of 100. Main character energy at its most terminal.",
